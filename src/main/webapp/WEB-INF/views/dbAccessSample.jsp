...
​
	...
	<div style="padding: 10px;">
		<table
			...
			<tr>
				<th style="border: solid 1px #cbcbcb; width: 150px;">都道府県</th>
				<th style="border: solid 1px #cbcbcb;">県庁所在地</th>
				<th style="border: solid 1px #cbcbcb; width: 150px;">地方</th>
			</tr>
			<c:forEach var="item" items="${items}">
				<tr>
					<th style="border: solid 1px #cbcbcb; width: 150px;">${item.get("id")}</th>
					<th style="border: solid 1px #cbcbcb;">${item.get("name")}</th>
					<th style="border: solid 1px #cbcbcb; width: 150px;">${item.get("regionName")}</th>
				</tr>
			</c:forEach>
		</table>
	</div>
