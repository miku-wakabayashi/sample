package com.seattleacademy20.sample;
...
//        jdbcTemplate.update("INSERT INTO genders (id, name) VALUES (5, \"回答なし\")");
...
//        logger.info("Welcome home! The client locale is {}.", locale);
//        // 本当は画面からパラメータを受け取って登録したい気分・・・
//        jdbcTemplate.update("UPDATE genders SET name = \"回答あるけど字が汚くて読めない\" WHERE id = 5");
...
//        logger.info("Welcome home! The client locale is {}.", locale);
//        // 本当は画面からパラメータを受け取って登録したい気分・・・
//        jdbcTemplate.update("DELETE FROM genders WHERE id = 5");
        ...
        List<Map<String, String>> list = jdbcTemplate.query("select name, capital_city from prefectures",
                new RowMapper<Map<String, String>>() {
                    ...
                    public Map<String, String> mapRow(ResultSet rs, int rowNum) throws SQLException {
                        ...
                        map.put("name", rs.getString("capital_city"));
                        return map;
                    }
                });
        return list;
